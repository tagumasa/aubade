...
/* Aubade: build the 8-bit library with JIT and Unicode support (see
README.md). SUPPORT_UNICODE is what makes PCRE2_UTF compilation — and
therefore character (rather than byte) semantics for pathspec wildcards —
possible. */
