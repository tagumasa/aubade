...
tags_infer_override :: proc(name: string) -> string {
	switch name {
	case "perl":
		return "(package_statement (package) @name) @definition.module\n" +
			"(subroutine_declaration_statement (bareword) @name) @definition.function"
	case "go":
		return "(function_declaration name: (identifier) @name) @definition.function\n" +
			"(method_declaration name: (field_identifier) @name) @definition.method\n" +
			"(call_expression function: (identifier) @name) @reference.call\n" +
			"(call_expression function: (selector_expression field: (field_identifier) @name)) @reference.call"
	case "python":
		return "(function_definition (identifier) @name) @definition.function\n" +
	...
	case "javascript":
		return "(function_declaration (identifier) @name) @definition.function\n" +
	...
	case "typescript", "tsx":
		return "(function_declaration (identifier) @name) @definition.function\n" +
			...
			"(call_expression (member_expression (property_identifier) @name)) @reference.call"
	case "java":
		return "(method_declaration (identifier) @name) @definition.method\n" +
			"(class_declaration (identifier) @name) @definition.class\n" +
	...
	case "rust":
		return "(function_item (identifier) @name) @definition.function\n" +
	...
	case "c":
		return "(function_definition (function_declarator (identifier) @name)) @definition.function\n" +
	...
	case "php":
		...
		return "(function_definition (name) @name) @definition.function\n" +
	...
	case "erlang":
		return "(fun_decl (function_clause (atom) @name)) @definition.function\n" +
			"(record_decl (atom) @name) @definition.record"
	case "ocaml":
		return "(type_definition (type_binding name: (type_constructor) @name)) @definition.type\n" +
	...
	case "bash":
		return "(function_definition name: (word) @name) @definition.function"
	case "fish":
		return "(function_definition name: (word) @name) @definition.function"
	case "graphql":
		return "(object_type_definition (name) @name) @definition.type\n" +
	...
	case "ruby":
		...
		return "(class (constant) @name) @definition.class\n" +
	...
	case "kotlin":
		...
		return `(class_declaration "interface" (type_identifier) @name) @definition.interface` + "\n" +
	...
	case "swift":
		...
		return "(protocol_declaration (type_identifier) @name) @definition.interface\n" +
			`(class_declaration "class" (type_identifier) @name (class_body)) @definition.class` + "\n" +
			...
			"(enum_entry (simple_identifier) @name) @definition.enum_member"
	case "scala":
		return "(trait_definition name: (identifier) @name) @definition.interface\n" +
	...
	case "dart":
		return "(class_definition (identifier) @name) @definition.class\n" +
			"(enum_declaration (identifier) @name) @definition.type\n" +
	...
	case "zig":
		...
		return "(variable_declaration (identifier) @name (struct_declaration)) @definition.type\n" +
	...
	case "elixir":
		...
		return `(call (identifier) @_head (arguments (alias) @name) (#eq? @_head "defmodule")) @definition.module` + "\n" +
			`(call (identifier) @_head (arguments (call (identifier) @name)) (#any-of? @_head "def" "defp" "defmacro")) @definition.function` + "\n" +
			"(call (identifier) @name) @reference.call"
	case "julia":
		return "(module_definition (identifier) @name) @definition.module\n" +
	...
	case "solidity":
		return "(contract_declaration name: (identifier) @name) @definition.class\n" +
	...
	case "nim":
		return "(type_declaration (type_symbol_declaration (identifier) @name) (object_declaration)) @definition.type\n" +
			...
			"(call (identifier) @name) @reference.call"
	case "crystal":
		return "(module_def (constant) @name) @definition.module\n" +
	...
	case "d":
		return "(interface_declaration (identifier) @name) @definition.interface\n" +
			"(class_declaration (identifier) @name) @definition.class\n" +
	...
	case "thrift":
		return "(struct_definition (identifier) @name) @definition.type\n" +
	...
	case "hcl":
		...
		return "(block (identifier) (string_lit (template_literal) @name) . (block_start)) @definition.block\n" +
	...
	case "cmake":
		...
		return "(function_def (function_command (function) (argument_list . (argument (unquoted_argument) @name)))) @definition.function\n" +
			"(macro_def (macro_command (macro) (argument_list . (argument (unquoted_argument) @name)))) @definition.macro"
	case "powershell":
		return "(function_statement (function_name) @name) @definition.function\n" +
	...
	case "sql":
		return "(create_table_statement (identifier) @name) @definition.type\n" +
	...
	case "proto":
		return "(message (message_name (identifier) @name)) @definition.message\n" +
	...
	case "commonlisp":
		return "(defun (defun_header function_name: (sym_lit) @name)) @definition.function\n" +
	...
	case "scheme":
		return `(list . (symbol) @_head . (list . (symbol) @name) (#eq? @_head "define")) @definition.function` + "\n" +
